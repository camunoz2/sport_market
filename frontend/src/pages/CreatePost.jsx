...
const CreateListing = () => {
  ...
  return (
    <div className="flex flex-col justify-center items-center min-h-screen bg-gray-100 p-4">
      <div className="bg-white shadow-lg rounded-lg p-6 flex flex-col lg:flex-row w-full max-w-4xl">
        {/* Sección de Imagen */}
        ...
        <div className="w-full lg:w-1/2 lg:pl-4">
          ...
          <div className="flex flex-col lg:flex-row justify-between">
            ...
            <button className="bg-gray-400 text-white px-4 py-2 rounded">Cancelar</button>
          </div>
        </div>
      </div>
