...
export default function CartPage() {
  ...
  return (
    <div className="flex flex-col items-center min-h-screen p-4">
              ...
              >
                ...
                <div className="flex flex-col sm:flex-row items-center gap-2 sm:gap-4">
                  <div className="flex items-center gap-2">
                    <button onClick={() => decreaseQuantity(item)} className="bg-gray-300 hover:bg-gray-400 text-black py-1 px-3 rounded">
                      -
                    </button>
                    <span className="text-lg">{item.quantity}</span>
                    <button onClick={() => addToCart(item)} className="bg-gray-300 hover:bg-gray-400 text-black py-1 px-3 rounded">
                      +
                    </button>
                  </div>
                  ...
                  <button onClick={() => removeItem(item)} className="bg-red-500 hover:bg-red-600 text-white py-1 px-3 rounded">
                    Eliminar
                  </button>
                </div>
              </div>
      ...
      <a href="/" className="mt-6 bg-blue-500 hover:bg-blue-600 text-white px-6 py-2 rounded">
        Volver al Home
      </a>
    </div>
  );
